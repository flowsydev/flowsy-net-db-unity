...
public static partial class DbConnectionExtensions
{
    ...
    /// </returns>
    public static T GetSingleFromRoutine<T>(
        ...
        => connection.GetSingleFromRoutine(
            routineName,
            null,
    ...
    /// The single result of the routine execution as an instance of T.
    /// </returns>
    public static Task<T> GetSingleFromRoutineAsync<T>(
        this IDbConnection connection,
        string routineName, 
        dynamic? parameters = null,
        IDbTransaction? transaction = null,
        ...
        => connection.GetSingleFromRoutineAsync(
            routineName,
            null,
            parameters as object,
            transaction,
    ...
    /// The single result of the routine execution as an instance of T.
    /// </returns>    
    public static async Task<T> GetSingleFromRoutineAsync<T>(
        this IDbConnection connection,
        string routineName,
        DbRoutineType? routineType = null,
        dynamic? parameters = null, 
